import{a as be,b as ke,c as we,f as ve,g as Ge}from"./chunk-TSP7SOOG.js";import{M as he,N as Ne,O as me,P as De,V as fe,W as Be,a as pe,b as o,c as Le}from"./chunk-7IVYTBLT.js";import{a as He}from"./chunk-AT2XSL35.js";import{c as ge,d as z,g as E,i as F}from"./chunk-PZVDA2MQ.js";import{p as le,q as Ee}from"./chunk-VNJBHSGE.js";import{c as ae,e as ie,m as Me}from"./chunk-NL4KBZEL.js";import{a as ue,b as Re}from"./chunk-NJ5BLOSZ.js";import{Db as Oe,Fb as ce,Hb as $e,d as te,e as re,g as Se,w as oe,x as Ae,yb as de}from"./chunk-XBTSVDFA.js";import{a as se,b as Te}from"./chunk-M5D6GWR5.js";import{d as s,h as ne}from"./chunk-JKEFPP22.js";import{$c as Z,Cb as q,Dc as N,Ea as k,Ec as p,Ed as M,Fc as f,Fd as T,Gc as D,Hb as m,Ma as R,Na as L,Nc as B,Tc as G,Vc as w,Yb as X,Za as S,Zc as Q,_c as Y,fd as j,ib as K,id as _,ie as ee,jd as A,kd as U,uc as J,wc as y,yc as x}from"./chunk-GLZGF54H.js";import{a as P,b as $,e as H,j as b}from"./chunk-W2MMT6XF.js";var _e,Ce=H(()=>{"use strict";_e=`
<style id="sp-ui-kit">
  *, *::before, *::after {
...
`});var je,ye,Ue,W,ze,Fe,xe,Ie,We,Pe=H(()=>{"use strict";Le();ne();Ce();je=new Set(["getTasks","getArchivedTasks","getCurrentContextTasks","getSelectedTask","getFocusedTask","selectTask","reInitData","updateTask","addTask","deleteTask","batchUpdateForProject","reorderTasks","getAllProjects","addProject","updateProject","deleteProject","getAllTags","addTag","updateTag","showSnack","notify","request","translate","formatDate","getCurrentLanguage","openDialog","showIndexHtmlAsView","showIndexHtmlInSidePanel","showInWorkContext","closeWorkContextView","getActiveWorkContext","getAppState","persistDataSynced","loadPersistedData","registerHook","registerWorkContextHeaderButton","executeNodeScript","dispatchAction","setCounter","getCounter","incrementCounter","decrementCounter","deleteCounter","getAllCounters"]),ye=t=>{let n=t.trim().replace(/\s+/g,"").toLowerCase();return!n||n==="transparent"||/^#[\da-f]{3}0$/.test(n)||/^#[\da-f]{6}00$/.test(n)||/^.+\/0(?:\.0+)?%?\)$/.test(n)?!0:/^(?:rgba?|hsla?)\([^,]+,[^,]+,[^,]+,0(?:\.0+)?%?\)$/.test(n)},Ue=(t,n,e)=>ye(t)?ye(n)?e:n:t,W="__hasDialogButtonHandler",ze=()=>{let t=document.body.classList.contains("isDarkTheme"),n=getComputedStyle(document.body),e=c=>n.getPropertyValue(c).trim(),r=e("--bg"),a=e("--bg-lighter"),i=Ue(e("--card-bg"),a,r);return`
  ...
  `},Fe=t=>`
    ...
    <\/script>
  `,xe=t=>{let n=Fe(t),a=ze()+(t.manifest.uiKit!==!1?_e:"")+n,i=t.indexHtml,c=i.match(/<head[^>]*>/i);if(c){let u=c.index+c[0].length;return i.slice(0,u)+a+i.slice(u)}return a+i},Ie=(t,n)=>b(null,null,function*(){let{data:e}=t;if(!(!e||typeof e!="object")&&We(e,n)){if(n.boundMethods||(n.boundMethods=n.pluginBridge.createBoundMethods(n.pluginId,n.manifest)),e.type===o.API_CALL&&e.callId){let{method:r,args:a=[],callId:i}=e;try{if(!je.has(r))throw new Error(`Unknown API method: ${r}`);if(r==="registerWorkContextHeaderButton"&&a.length>=1){let d=a[0],g=d.label;if(typeof g!="string"||!g)throw new Error("registerWorkContextHeaderButton requires a string label");let l=$(P({},d),{onClick:O=>{t.source?.postMessage({type:o.WORK_CONTEXT_BTN_CLICK,buttonHandlerId:g,ctx:O},"*")}}),C=n.boundMethods.registerWorkContextHeaderButton,I=yield C(l);t.source?.postMessage({type:o.API_RESPONSE,callId:i,result:I},{targetOrigin:"*"});return}if(r==="registerHook"){let d=n.pluginBridge;if(a.length>=2){let[g,l]=a;s.log("Plugin iframe registerHook:",{hook:g,handlerPlaceholder:l,pluginId:n.pluginId});let h;if(l==="IFRAME_HANDLER"){let C=I=>{t.source?.postMessage({type:o.HOOK_EVENT,hook:g,payload:I},"*")};h=yield d.registerHook(n.pluginId,g,C)}else throw new Error("Iframe registerHook calls must use IFRAME_HANDLER");t.source?.postMessage({type:o.API_RESPONSE,callId:i,result:h},{targetOrigin:"*"});return}}let c=n.boundMethods;if(c&&typeof c[r]=="function"){let d=yield c[r](...a||[]);t.source?.postMessage({type:o.API_RESPONSE,callId:i,result:d},"*");return}let u=n.pluginBridge;if(typeof u[r]!="function")throw new Error(`Unknown API method: ${r}`);if(r==="openDialog"&&a.length>=1){let d=a[0];d.buttons&&(d.buttons=d.buttons.map((l,h)=>{if(l[W]){let C=P({},l);return delete C[W],$(P({},C),{onClick:()=>b(null,null,function*(){return t.source?.postMessage({type:o.DIALOG_BUTTON_CLICK,buttonIndex:h,dialogCallId:i},{targetOrigin:"*"}),new Promise((I,O)=>{let V=v=>{v.source===t.source&&v.data?.bridgeToken===n.bridgeToken&&v.data?.bridgeGeneration===n.bridgeGeneration&&v.data?.type===o.DIALOG_BUTTON_RESPONSE&&v.data?.dialogCallId===i&&v.data?.buttonIndex===h&&(window.removeEventListener("message",V),v.data.error?O(new Error(v.data.error)):I(v.data.result))};window.addEventListener("message",V)})})})}return l}));let g=yield u[r](d);t.source?.postMessage({type:o.API_RESPONSE,callId:i,result:g},"*")}else{let d=yield u[r](...a||[]);t.source?.postMessage({type:o.API_RESPONSE,callId:i,result:d},"*")}}catch(c){t.source?.postMessage({type:o.API_ERROR,callId:i,error:c instanceof Error?c.message:"Unknown error"},"*")}}if(e.type===o.MESSAGE&&e.messageId)try{let r=yield n.pluginBridge.sendMessageToPlugin(n.pluginId,e.message);t.source?.postMessage({type:o.MESSAGE_RESPONSE,messageId:e.messageId,result:r},"*")}catch(r){t.source?.postMessage({type:o.MESSAGE_ERROR,messageId:e.messageId,error:r instanceof Error?r.message:"Unknown error"},"*")}e.type===o.READY&&e.pluginId===n.pluginId&&s.log(`Plugin ${n.pluginId} is ready`)}}),We=(t,n)=>!new Set([o.API_CALL,o.MESSAGE,o.READY]).has(t.type)||t.type===o.MESSAGE?!0:t.bridgeToken===n.bridgeToken&&t.bridgeGeneration===n.bridgeGeneration});function Ke(t,n){if(t&1&&(p(0,"mat-card",3)(1,"mat-card-content")(2,"div",5),D(3,"mat-progress-spinner",6),p(4,"p"),_(5),M(6,"translate"),f()()()()),t&2){let e=w(2);m(5),A(T(6,1,e.T.PLUGINS.LOADING_INTERFACE))}}function qe(t,n){if(t&1&&(p(0,"div",4),D(1,"mat-progress-spinner",7),p(2,"p"),_(3),M(4,"translate"),f()()),t&2){let e=w(2);m(3),A(T(4,1,e.T.PLUGINS.LOADING_PLUGIN))}}function Xe(t,n){if(t&1&&y(0,Ke,7,3,"mat-card",3)(1,qe,5,3,"div",4),t&2){let e=w();x(e.showFullUI?0:1)}}function Je(t,n){if(t&1){let e=B();p(0,"mat-card",8)(1,"mat-card-header")(2,"mat-card-title")(3,"mat-icon",10),_(4,"error"),f(),_(5),M(6,"translate"),f()(),p(7,"mat-card-content")(8,"p"),_(9),f(),p(10,"button",11),G("click",function(){R(e);let a=w(2);return L(a.goBack())}),_(11),M(12,"translate"),f()()()}if(t&2){let e=w(2);m(5),U(" ",T(6,3,e.T.PLUGINS.ERROR_LOADING_PLUGIN)," "),m(4),A(e.error()),m(2),U(" ",T(12,5,e.T.PLUGINS.GO_BACK)," ")}}function Qe(t,n){if(t&1&&(p(0,"div",9)(1,"mat-icon"),_(2,"error_outline"),f(),p(3,"p"),_(4),f()()),t&2){let e=w(2);m(4),A(e.error())}}function Ye(t,n){if(t&1&&y(0,Je,13,7,"mat-card",8)(1,Qe,5,1,"div",9),t&2){let e=w();x(e.showFullUI?0:1)}}function Ze(t,n){if(t&1){let e=B();p(0,"div",12)(1,"iframe",13,0),G("load",function(){R(e);let a=w();return L(a.onIframeLoad())}),f()()}if(t&2){let e=w();j("is-resizing",e.isResizing()),m(),j("hidden",e.isLoading()),N("srcdoc",e.iframeSrcdoc(),q),J("data-plugin-id",e.pluginId())}}var Ve,At,et=H(()=>{"use strict";ee();Me();Ae();He();Be();Ne();De();Pe();Ge();Se();Te();ne();Ee();Oe();$e();Re();ee();Ve=["iframe"];At=(()=>{class t{constructor(){this.showFullUI=!0,this.useSidePanelConfig=!1,this.skipCleanupOnDestroy=!1,this._route=k(ae),this._router=k(ie),this._elRef=k(K),this._sanitizer=k(oe),this._pluginService=k(fe),this._pluginBridge=k(he),this._cleanupService=k(me),this._translateService=k(te),this._layoutService=k(le),this.T=se,this.pluginId=S(""),this.isLoading=S(!0),this.error=S(null),this.iframeSrcdoc=S(null),this.isResizing=this._layoutService.isPanelResizing,this._isDestroyed=!1}ngOnInit(){return b(this,null,function*(){if(this.directPluginId){this.pluginId.set(this.directPluginId),yield this._waitForPluginSystem();try{yield this._loadPluginIndex(this.directPluginId)}catch(e){s.err("Failed to load plugin index:",e),this.error.set(e instanceof Error?e.message:"Failed to load plugin"),this.isLoading.set(!1)}return}this._routeSubscription=this._route.paramMap.subscribe(e=>b(this,null,function*(){let r=e.get("pluginId");if(s.log("Route paramMap changed, newPluginId:",r,"currentPluginId:",this.pluginId()),!r){this.error.set("Plugin ID not provided"),this.isLoading.set(!1);return}if(this.pluginId()===r){s.log("Same plugin ID, skipping reload");return}s.log(`Navigating from plugin "${this.pluginId()}" to plugin "${r}"`),this._cleanupIframeCommunication(),this.isLoading.set(!0),this.error.set(null),this.pluginId.set(r),yield this._waitForPluginSystem();try{yield this._loadPluginIndex(r)}catch(a){s.err("Failed to load plugin index:",a),this.error.set(a instanceof Error?a.message:"Failed to load plugin"),this.isLoading.set(!1)}}))})}_waitForPluginSystem(){return b(this,null,function*(){if(!this._pluginService.isInitialized())try{yield this._pluginService.initializePlugins()}catch(e){throw s.err("Failed to initialize plugin system:",e),new Error("Failed to initialize plugin system")}})}ngOnDestroy(){this._isDestroyed=!0,this._cleanupIframeCommunication(),this._routeSubscription&&this._routeSubscription.unsubscribe()}goBack(){this._router.navigate(["/config"],{fragment:"plugins"})}_getIndexHtmlWhenLoaded(e){return b(this,null,function*(){let r=this._pluginService.getPluginIndexHtml(e);return r||(this._pluginService.pluginStates().get(e)?.status!=="loading"?null:(s.log(`Plugin ${e} is still loading, waiting before opening index`),yield this._pluginService.activatePlugin(e),this._pluginService.getPluginIndexHtml(e)))})}_loadPluginIndex(e){return b(this,null,function*(){s.log(`Loading plugin index for: ${e}`);let r=yield this._getIndexHtmlWhenLoaded(e);if(this.pluginId()!==e){s.log(`Plugin ${e} load superseded by ${this.pluginId()}`);return}if(!r){s.err(`No index.html content found for plugin: ${e}`);let l=(yield this._pluginService.getAllPlugins()).find(h=>h.manifest.id===e);throw l?l.manifest.iFrame?l.error?new Error(l.error):new Error("Plugin index.html not loaded"):new Error("Plugin does not support iframes"):new Error("Plugin not found")}let i=(yield this._pluginService.getAllPlugins()).find(g=>g.manifest.id===e);if(!i)throw new Error("Plugin not found");let c=yield this._pluginService.getBaseCfg();if(this._isDestroyed)return;let u={pluginId:e,manifest:i.manifest,indexHtml:r,baseCfg:c,pluginBridge:this._pluginBridge,bridgeToken:this._createBridgeToken(),bridgeGeneration:this._pluginService.getPluginIframeGeneration(e),boundMethods:this._pluginBridge.createBoundMethods(e,i.manifest)},d=xe(u);this._messageListener=g=>b(this,null,function*(){let l=g,h=this._getPluginIframeWindow();!h||l.source!==h||this._pluginService.getPluginIframeGeneration(u.pluginId)===u.bridgeGeneration&&this._pluginService.getPluginIndexHtml(u.pluginId)&&(yield Ie(l,u))}),window.addEventListener("message",this._messageListener),this.iframeSrcdoc.set(this._sanitizer.bypassSecurityTrustHtml(d)),this.isLoading.set(!1),s.log(`Plugin ${e} iframe srcdoc set, loading complete`)})}_createBridgeToken(){let e=new Uint8Array(16);return crypto.getRandomValues(e),Array.from(e,r=>r.toString(16).padStart(2,"0")).join("")}_getPluginIframeWindow(){return this._elRef.nativeElement.querySelector("iframe[data-plugin-iframe]")?.contentWindow??null}_cleanupIframeCommunication(){let e=this.pluginId();s.log(`Cleaning up iframe communication for plugin: ${e}`),this._messageListener&&(window.removeEventListener("message",this._messageListener),this._messageListener=void 0,s.log(`Removed message listener for plugin: ${e}`)),e&&!this.skipCleanupOnDestroy&&(this._cleanupService.cleanupPlugin(e),s.log(`Cleaned up plugin references for: ${e}`)),this.iframeSrcdoc.set(this._sanitizer.bypassSecurityTrustHtml("<html><body></body></html>")),s.log(`Reset iframe to empty document for plugin: ${e}`)}onIframeLoad(){s.log("Plugin iframe loaded for plugin:",this.pluginId()),this.iframeRef?.nativeElement&&this.pluginId()&&this._cleanupService.registerIframe(this.pluginId(),this.iframeRef.nativeElement)}static{this.\u0275fac=function(r){return new(r||t)}}static{this.\u0275cmp=X({type:t,selectors:[["plugin-index"]],viewQuery:function(r,a){if(r&1&&Q(Ve,5),r&2){let i;Y(i=Z())&&(a.iframeRef=i.first)}},inputs:{directPluginId:"directPluginId",showFullUI:"showFullUI",useSidePanelConfig:"useSidePanelConfig",skipCleanupOnDestroy:"skipCleanupOnDestroy"},decls:4,vars:4,consts:[["iframe",""],[1,"plugin-index-container"],[1,"iframe-container",3,"is-resizing"],[1,"loading-card"],[1,"simple-loading"],[1,"loading-content"],["mode","indeterminate","diameter","40"],["mode","indeterminate","diameter","24"],[1,"error-card"],[1,"simple-error"],["color","warn"],["mat-button","","color","primary",3,"click"],[1,"iframe-container"],["data-plugin-iframe","","sandbox","allow-scripts allow-same-origin allow-forms allow-popups allow-modals",1,"plugin-iframe",3,"load","srcdoc"]],template:function(r,a){r&1&&(p(0,"div",1),y(1,Xe,2,1),y(2,Ye,2,1),y(3,Ze,3,6,"div",2),f()),r&2&&(N("@pluginSwitch",a.pluginId()),m(),x(a.isLoading()?1:-1),m(),x(a.error()?2:-1),m(),x(a.iframeSrcdoc()&&!a.error()?3:-1))},dependencies:[de,ce,ue,be,we,ve,ke,re],styles:["@media screen and (min-width:600px){.isNoMac[_ngcontent-%COMP%]{scrollbar-color:var(--scrollbar-thumb) var(--scrollbar-track);scrollbar-width:4px}.isNoMac[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar{width:4px;height:4px}.isNoMac[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-track{background:var(--scrollbar-track);border-radius:var(--card-border-radius)}.isNoMac[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-thumb{background:var(--scrollbar-thumb);border-radius:16px}.isNoMac[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-thumb:hover{background:var(--scrollbar-thumb-hover)}}@media screen and (max-width:599px){.isNoTouchOnly[_ngcontent-%COMP%]{scrollbar-color:var(--scrollbar-thumb) var(--scrollbar-track);scrollbar-width:4px}.isNoTouchOnly[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar{width:4px;height:4px}.isNoTouchOnly[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-track{background:var(--scrollbar-track);border-radius:var(--card-border-radius)}.isNoTouchOnly[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-thumb{background:var(--scrollbar-thumb);border-radius:16px}.isNoTouchOnly[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-thumb:hover{background:var(--scrollbar-thumb-hover)}}.plugin-index-container[_ngcontent-%COMP%]{height:100%;display:flex;flex-direction:column;overflow:hidden}.loading-card[_ngcontent-%COMP%], .error-card[_ngcontent-%COMP%]{margin:2rem;max-width:600px;align-self:center}.loading-content[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;gap:1rem;padding:2rem}.loading-content[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin:0;color:var(--text-color-muted)}.error-card[_ngcontent-%COMP%]   .mat-card-header[_ngcontent-%COMP%]   .mat-card-title[_ngcontent-%COMP%]{display:flex;align-items:center;gap:.5rem;color:var(--color-danger)}.error-card[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin-bottom:1rem;color:var(--text-color)}.simple-loading[_ngcontent-%COMP%], .simple-error[_ngcontent-%COMP%]{display:flex;flex-direction:column;align-items:center;justify-content:center;height:100%;gap:var(--s2)}.simple-error[_ngcontent-%COMP%]{color:var(--color-danger)}.simple-error[_ngcontent-%COMP%]   mat-icon[_ngcontent-%COMP%]{font-size:48px;width:48px;height:48px}.simple-loading[_ngcontent-%COMP%]   p[_ngcontent-%COMP%], .simple-error[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{margin:0;opacity:.7}.iframe-container[_ngcontent-%COMP%]{flex:1;position:relative;overflow:hidden}.iframe-container.is-resizing[_ngcontent-%COMP%], .iframe-container.is-resizing[_ngcontent-%COMP%]   iframe[_ngcontent-%COMP%]{pointer-events:none}.plugin-iframe[_ngcontent-%COMP%]{width:100%;height:100%;border:none;background:transparent;scrollbar-color:var(--scrollbar-thumb) var(--scrollbar-track);scrollbar-width:4px}.plugin-iframe[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar{width:4px;height:4px}.plugin-iframe[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-track{background:var(--scrollbar-track);border-radius:var(--card-border-radius)}.plugin-iframe[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-thumb{background:var(--scrollbar-thumb);border-radius:16px}.plugin-iframe[_ngcontent-%COMP%]   [_ngcontent-%COMP%]::-webkit-scrollbar-thumb:hover{background:var(--scrollbar-thumb-hover)}.plugin-iframe.hidden[_ngcontent-%COMP%]{visibility:hidden}"],data:{animation:[ge("pluginSwitch",[F(":enter",[E({opacity:0,transform:"translateX(20px)"}),z("300ms ease-in-out",E({opacity:1,transform:"translateX(0)"}))]),F("* => *",[E({opacity:0,transform:"translateX(-20px)"}),z("300ms ease-in-out",E({opacity:1,transform:"translateX(0)"}))])])]},changeDetection:0})}}return t})()});export{At as a,et as b};
